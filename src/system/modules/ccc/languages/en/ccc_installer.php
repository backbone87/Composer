...
$GLOBALS['TL_LANG']['ccc_installer']['welcome_headline']
	= 'Contao Composer Client – Installation';

$GLOBALS['TL_LANG']['ccc_installer']['welcome_intro']
...
$GLOBALS['TL_LANG']['ccc_installer']['welcome_beta']
...
$GLOBALS['TL_LANG']['ccc_installer']['welcome_faq']
	= 'FAQ';

$GLOBALS['TL_LANG']['ccc_installer']['welcome_faq_intro']
	= 'At first we want to answer the some important questions:';

$GLOBALS['TL_LANG']['ccc_installer']['welcome_faq_questions'][] = array(
...
$GLOBALS['TL_LANG']['ccc_installer']['welcome_install']
	= 'Installation';

$GLOBALS['TL_LANG']['ccc_installer']['welcome_install_intro']
	= 'This wizard will help you to install Composer in your Contao system and
migrate existing ER2 extensions, if necessary.';

$GLOBALS['TL_LANG']['ccc_installer']['welcome_next']
	= 'Start installation';
