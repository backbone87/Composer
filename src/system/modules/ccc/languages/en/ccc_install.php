...
$GLOBALS['TL_LANG']['ccc_install']['settings_next']
	= 'Continue';


$GLOBALS['TL_LANG']['ccc_install']['summary_headline']
	= 'Contao Composer Client – Installation – Summary &amp; completion';

$GLOBALS['TL_LANG']['ccc_install']['summary_er2Composer']
	= 'Following ER2 extensions will be migrated into Composer:';

$GLOBALS['TL_LANG']['ccc_install']['summary_settings']
	= 'Following initial settings will be used to configure Composer:';

$GLOBALS['TL_LANG']['ccc_install']['summary_install']
	= 'Install';
